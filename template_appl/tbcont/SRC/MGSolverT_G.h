#ifndef __mgsolverTg_h__
#define __mgsolverTg_h__
...
public:
  ...
  MGSolT_G(MGEquationsSystem& mg_equations_map_in,   ///< Constructor
	 int             nvars_in[],         // KLQ number of variables
         std::string eqname_in="T_g",
         std::string varname_in="g"
        );
  ~MGSolT_G() {}                                  ///< Destructor
