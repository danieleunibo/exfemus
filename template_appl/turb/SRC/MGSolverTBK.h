#ifndef __mgsolverTBK_h__
#define __mgsolverTBK_h__
...
public:
  ...
  MGSolTBK(MGEquationsSystem& mg_equations_map_in,   ///< Constructor
	 int             nvars_in[],    
         std::string eqname_in="K",
         std::string varname_in="k"
        );
  ~MGSolTBK() {}                                  ///< Destructor
