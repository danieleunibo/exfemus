...
// =============================================================
std::auto_ptr<LinearSolverM > LinearSolverM::build(
  ...
  switch (solver_package)  {
    ...
    case LASPACK_SOLVERSM:  {
 	std::auto_ptr<LinearSolverM > ap(new LaspackLinearSolverM(comm));
 	return ap;
      }
#endif
#ifdef HAVE_PETSCM
    case PETSC_SOLVERSM:      {
	std::auto_ptr<LinearSolverM > ap(new PetscLinearSolverM(comm));
	return ap;
      }
#endif
#ifdef HAVE_TRILINOS
    case TRILINOS_SOLVERSM:  {
	std::auto_ptr<LinearSolverM > ap(new AztecLinearSolverM(comm));
	return ap;
      }
#endif
