...
public:
    ...
    std::auto_ptr<NumericVectorM > zero_clone () const;
...
// *** ============================================
inline std::auto_ptr<NumericVectorM > DistributedVectorM::zero_clone () const {
    std::auto_ptr<NumericVectorM > cloned_vector (new DistributedVectorM(this->comm()));
    cloned_vector->init(*this);
    return cloned_vector;
}
// ============================================
inline std::auto_ptr<NumericVectorM > DistributedVectorM::clone () const {
    std::auto_ptr<NumericVectorM > cloned_vector (new DistributedVectorM(this->comm()));
