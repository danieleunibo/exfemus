...
// 		      int gl_node_med=node_id[gl_node_bd];
//                      ext_es->_interfaceFunMap[ fabs(bc_id[gl_node_bd])]->eval_node(gl_node_med,DIMENSION, bc_value);
// 		  }
// // 		   if ( fabs(bc_id[gl_node_bd])==111 ) {
// //                      int gl_node_med= ext_es->_interfaceFunMap[fabs(bc_id[gl_node_bd])]->NodeID()[gl_node_bd];
// //                      ext_es->_interfaceFunMap[ fabs(bc_id[gl_node_bd])]->eval_node(gl_node_med, bc_value);
// // 		  }
// // 		   if ( fabs(bc_id[gl_node_bd])==111 ) {
// //                      int gl_node_med=node_id[gl_node_bd];
// //                      ext_es->_interfaceFunMap[ fabs(bc_id[gl_node_bd])]->eval_node(gl_node_med, DIMENSION,bc_value);
