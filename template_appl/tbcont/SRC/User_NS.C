...
// cyl
  if (xp[0] < LXB*ILref + BDRY_TOLL) {bc_flag[0]=0; bc_flag[1]=0; bc_Neum[0]=0; bc_Neum[1]=0;} //  left
  if (xp[0] > LXE*ILref - BDRY_TOLL) {bc_flag[0]=0; bc_flag[1]=0; bc_Neum[0]=1; bc_Neum[1]=1;} //  right
  if (xp[1] > LYE*ILref - BDRY_TOLL) {bc_flag[0]=5; bc_flag[1]=5; bc_Neum[0]=0; bc_Neum[1]=0;} //  top
  if (xp[1] < LYB*ILref + BDRY_TOLL) {bc_flag[0]=5; bc_flag[1]=5; bc_Neum[0]=0; bc_Neum[1]=0;} //  bottom
  if (xp[1] < LYB*ILref + BDRY_TOLL && xp[0] > 1. && xp[0] <2.) {bc_flag[0]=5; bc_flag[1]=3; bc_Neum[0]=0; bc_Neum[1]=0;} //  bottom
  
//   // channel with injection
//   if (bc_gam==20) {bc_flag[0]=0; bc_flag[1]=0; bc_Neum[0]=0; bc_Neum[1]=0;} //big injection (left)
//   if (bc_gam==40) {bc_flag[0]=0; bc_flag[1]=0; bc_Neum[0]=1; bc_Neum[1]=1;} //outlet
//   if (bc_gam==30) {bc_flag[0]=5; bc_flag[1]=5; bc_Neum[0]=0; bc_Neum[1]=0;} //wall
//   if (bc_gam==10) {bc_flag[0]=5; bc_flag[1]=3; bc_Neum[0]=0; bc_Neum[1]=0;} //little injection
//   
//   if (xp[0] > 5. - BDRY_TOLL && (xp[1] <0. + BDRY_TOLL || xp[1] >1. - BDRY_TOLL)) 
//     {bc_flag[0]=5; bc_flag[1]=5; bc_Neum[0]=0; bc_Neum[1]=0;} //wall
