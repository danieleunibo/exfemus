...
QVector *LumpIter(QMatrix *A, QVector *x, QVector *b, int NoIter,
		    PrecondProcType Dummy, _LPDouble Omega);
QVector *VankaNSIter(QMatrix *A, QVector *x, QVector *b, int NoIter,
		    PrecondProcType Dummy, _LPDouble Omega);
QVector *VankaIter(QMatrix *A, QVector *x, QVector *b, int NoIter,
		    PrecondProcType Dummy, _LPDouble Omega);
