...
// cyl
  ...
  if (xp[1] < LYB*ILref + BDRY_TOLL) {bc_flag[0]=0; bc_flag[1]=0; bc_Neum[0]=0; bc_Neum[1]=0;} //  bottom
  if (xp[0] > LXE*ILref - BDRY_TOLL) {bc_flag[0]=0; bc_flag[1]=0; bc_Neum[0]=0; bc_Neum[1]=0;} //  right

// cyl_med
//   if (bc_gam==300) {bc_flag[0]=0; bc_flag[1]=0; bc_Neum[0]=0; bc_Neum[1]=1;} //  top
//   if (bc_gam==200) {bc_flag[0]=0; bc_flag[1]=0; bc_Neum[0]=0; bc_Neum[1]=1;} //  bottom
//   if (bc_gam==400) {bc_flag[0]=0; bc_flag[1]=0; bc_Neum[0]=0; bc_Neum[1]=1;} //  left
//   if (bc_gam==100) {bc_flag[0]=0; bc_flag[1]=0; bc_Neum[0]=0; bc_Neum[1]=0;} //  right
// annulus
//    if (xp[1] > LYE*ILref - BDRY_TOLL) {bc_flag[0]=0; bc_flag[1]=0; bc_Neum[0]=0; bc_Neum[1]=1;} //  top
...
//   bc_flag[0]=0;bc_flag[1]=0; bc_flag[2]=0; bc_Neum[0]=0;bc_Neum[1]=0;bc_Neum[2]=0; //wall
//   if (bc_gam==400) bc_flag[1]=1; bc_Neum[1]=0;
//   if (bc_gam==300) bc_flag[0]=1; bc_Neum[0]=0;
  
  
  if (xp[2]> LZE*ILref - BDRY_TOLL){bc_flag[0]=0;bc_flag[1]=0;bc_flag[2]=0; bc_Neum[0]=0;bc_Neum[1]=0;bc_Neum[2]=1;} //  OUTLET
  if (xp[0]> LXE*ILref - BDRY_TOLL){bc_flag[0]=0;bc_flag[1]=0;bc_flag[2]=0; bc_Neum[0]=0;bc_Neum[1]=0;bc_Neum[2]=1;}
  if (xp[1]> LYE*ILref - BDRY_TOLL){bc_flag[0]=0;bc_flag[1]=0;bc_flag[2]=0; bc_Neum[0]=0;bc_Neum[1]=0;bc_Neum[2]=1;} 
  if (xp[1]< LYB*ILref + BDRY_TOLL){bc_flag[0]=0;bc_flag[1]=0;bc_flag[2]=0; bc_Neum[0]=0;bc_Neum[1]=0;bc_Neum[2]=0;} 
  if (xp[0]< LXB*ILref + BDRY_TOLL){bc_flag[0]=0;bc_flag[1]=0;bc_flag[2]=0; bc_Neum[0]=0;bc_Neum[1]=0;bc_Neum[2]=0;}
  if (xp[2]< LZB*ILref + BDRY_TOLL){bc_flag[0]=0;bc_flag[1]=0;bc_flag[2]=0; bc_Neum[0]=0;bc_Neum[1]=0;bc_Neum[2]=0;} //  INLET
