...
std::auto_ptr<SparseMatrixM > SparseMatrixM::build( // -----
...
#ifdef HAVE_LASPACKM // ----------------------------
  case LASPACK_SOLVERSM: {std::auto_ptr<SparseMatrixM> ap(new LaspackMatrixM(comm));return ap;}
#endif
#ifdef HAVE_PETSCM // ------------------------------
  case PETSC_SOLVERSM: {std::auto_ptr<SparseMatrixM > ap(new PetscMatrixM(comm));return ap;}
#endif
#ifdef HAVE_TRILINOSM // ----------------------------
  case TRILINOS_SOLVERSM: {std::auto_ptr<SparseMatrixM > ap(new EpetraMatrix<double>);return ap;}
#endif
