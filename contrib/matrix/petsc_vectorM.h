...
public:
    ...
    virtual  std::auto_ptr<NumericVectorM > zero_clone () const;
...
inline std::auto_ptr<NumericVectorM > PetscVectorM::clone () const{
    std::auto_ptr<NumericVectorM> cloned_vector (new PetscVectorM(this->comm(), this->type()));
...
// ========================================================
inline std::auto_ptr<NumericVectorM > PetscVectorM::zero_clone () const{
    std::auto_ptr<NumericVectorM> cloned_vector (new PetscVectorM(this->comm(), this->type()));
