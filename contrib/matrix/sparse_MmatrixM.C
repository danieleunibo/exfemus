...
std::auto_ptr<SparseMMatrixM>  SparseMMatrixM::build(
...
// ------------------------------------------------------------
  ...
  switch (solver_package){
    ...
    case LASPACK_SOLVERSM:
      {	std::auto_ptr<SparseMMatrixM> ap(new LaspackMMatrixM(comm));
	return ap;
      }
#endif
#ifdef HAVE_PETSCM
    case PETSC_SOLVERSM:
      {	std::auto_ptr<SparseMMatrixM> ap(new PetscMMatrixM(comm));
	return ap;
      }
#endif
#ifdef HAVE_TRILINOSM
    case TRILINOS_SOLVERSM:
      {std::auto_ptr<SparseMMatrixM > ap(new EpetraMatrix<double>(comm));
	return ap;
      }
#endif
    default:
  ...
  std::auto_ptr<SparseMMatrixM> ap(NULL);
  return ap;    
}
