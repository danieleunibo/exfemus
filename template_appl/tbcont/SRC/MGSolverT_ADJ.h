...
class MGSolT_ADJ: public MGSolDA {
...
public:
  ...
  MGSolT_ADJ(MGEquationsSystem& mg_equations_map_in,   ///< Constructor
	 int             nvars_in[],         // KLQ number of variables
         std::string eqname_in="T_ad",
         std::string varname_in="T_ad"
        );
  ~MGSolT_ADJ() {}                                  ///< Destructor
