...
// #include "libmesh/libmesh_common.h" // assert, libmesh_cast_int
...
//     { return &_datatype; }
   ...
   * attributes, for values which can't be used with ParallelM min/max.
...
private:
  ...
  public:
     ...
     * the redundancy.
     */
#include "parallel_communicator_specializationsM"
