#ifndef __mgsolverTadj_h__
#define __mgsolverTadj_h__
...
class MGSolT_COUP: public MGSolDA {
...
//   double       _Nusselt;///< nondimensional Nusselt number
  ...
  double _beta;           ///< beta in the functional for boundary control
 ...
 int   _bc_vol[NDOF_FEM*2]; ///< element  b.cond flags
 int   _bc_bd[NDOF_FEM*2]; ///< element  b.cond flags  
...
public:
  ...
  MGSolT_COUP(MGEquationsSystem& mg_equations_map_in,   ///< Constructor
	 int             nvars_in[],         // KLQ number of variables
         std::string eqname_in="T_coup",
         std::string varname_in="T_coup"
        );
  ~MGSolT_COUP() {}                                  ///< Destructor
