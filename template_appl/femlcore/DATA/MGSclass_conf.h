...
//  Temperature dependence for physical properties --------------------
#define TEMPERATURE_DEPENDENCE_NS  (1) 

#define densityNS(x) (11367-1.1944*x)
#define viscosityNS(x) ((4.55e-04)*exp(1069/x))
// #define cipiT(x) (1.)
// #define kappa(x)  (1.)
...
//  Temperature dependence for physical properties --------------------
#define TEMPERATURE_DEPENDENCE_T  (1) 
#define densityT(x) (11367-1.1944*x)
#define cipiT(x) (1.)
#define kappaT(x)  (1.)
