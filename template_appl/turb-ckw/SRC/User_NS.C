...
// cyl_med
//   if (bc_gam==300) {bc_flag[0]=0; bc_flag[1]=0; bc_Neum[0]=1; bc_Neum[1]=1;} //  top
//   if (bc_gam==200) {bc_flag[0]=1; bc_flag[1]=1; bc_Neum[0]=0; bc_Neum[1]=0;} //  bottom
//   if (bc_gam==400) {bc_flag[0]=0; bc_flag[1]=0; bc_Neum[0]=1; bc_Neum[1]=1;} //  left
...
//   if (bc_gam==300) bc_flag[0]=1; bc_Neum[0]=0;
  ...
  if (xp[2]< LZB*ILref + BDRY_TOLL){bc_flag[0]=0;bc_flag[1]=0;bc_flag[2]=1; bc_Neum[0]=0;bc_Neum[1]=0;bc_Neum[2]=0;} //  INLET
