...
//                                   +  rho* Grad2_gi *phii_g
//                                +(1.-_kappa_g[_dir+ivar])*
                               + _c_source[ivar+_dir]*phii_g  
//                                -(1.-_kappa_g[_dir+ivar])*_c_diss[ivar+_dir]*phii_g
...
//     // eff visc coeff  fact_mu (all eq
//     double Re_t  =Re_t*(0.024+ 0.166666666667* Re_t)/(1.+0.166666666667* Re_t);
...
// //     }
//     Re_t  *=fact_mu;
//     _mu_turb=Re_t*(F1/1.176+(1.-F1));// =val[6]
// 
//     // source coeff val[5]  (kappa eq)
//     _c_source[0]= Re_t*_IRe*(0.111111111111+ 0.338983050847* Re_t)/(1.+0.338983050847* Re_t);
// 
// #endif
